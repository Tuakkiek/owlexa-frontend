...
file_path = "c:/Users/ADMIN/Owlexa/owlexa-frontend/src/pages/student/StudentSubmissionAttemptPage.tsx"

with open(file_path, "r", encoding="utf-8") as f:
    content = f.read()

# 1. Insert CountdownTimer component above StudentSubmissionAttemptPage definition
countdown_component = """
...
content = content.replace("export const StudentSubmissionAttemptPage = () => {", countdown_component)

# 2. Insert countdown usage in the header
header_target = """              {attempt && (
                <span
...
header_replacement = """              {attempt?.expiresAt && isEditable && (
                <CountdownTimer 
...
print("Updated StudentSubmissionAttemptPage.tsx")
