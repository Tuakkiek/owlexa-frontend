      ...
      <div className="flex flex-col gap-4 border-b border-gray-200 pb-5 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">
            Luyện tập với các đề thi thử và xem kết quả ngay sau khi nộp bài.
          </p>
        </div>
        <button
          onClick={loadData}
              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    disabled={isStarting}
                    className="mt-4 w-full rounded-lg bg-black px-4 py-2 text-sm font-medium text-white hover:bg-gray-900 disabled:opacity-60"
                  >
