      ...
      <div className="rounded-card border border-surface-border bg-white p-8">
          ...
          <div className="text-center mt-2">
            <span
              className={`inline-flex items-center rounded-full px-3 py-0.5 text-xs font-medium ${
                payment.feeRecordStatus === "PAID"
                  ? "bg-emerald-50 text-emerald-700"
                  : payment.feeRecordStatus === "OVERDUE"
        ...
        <div className="mt-12 grid grid-cols-2 gap-8">
          <div className="text-center">
            <div className="border-t border-gray-300 pt-2 text-sm text-gray-500">
              Người nộp
            </div>
          </div>
          <div className="text-center">
