...
import type { BulkTeacherRequest, BulkTeacherResult } from '../../../types/teacher';
...
export const BulkAddTeacherForm = ({ onSubmit, onCancel }: BulkAddTeacherFormProps) => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    const invalid = teachers.find(t => !t.phoneNumber || !t.fullName || !t.email);
    if (invalid) {
    ...
    return (
      <div className="space-y-4">
        <div className="bg-green-50 p-4 rounded text-green-800">
          Successfully processed {results.length} teachers.
        </div>
